...
<body>
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="logabout.php" class="nav-item nav-link active">About</a>
    ...
    <footer class="footer">
        ...
        <ul class="menu">
            <li class="menu__item"><a class="menu__link" href="#"> <i class="fab fa-facebook-f"></i> facebook </a></li>
            <li class="menu__item"><a class="menu__link" href="#"> <i class="fab fa-twitter"></i> twitter </a></li>
            <li class="menu__item"><a class="menu__link" href="#"> <i class="fab fa-linkedin"></i> linkedin </a></li>
            <li class="menu__item"><a class="menu__link" href="#"> <i class="fab fa-instagram"></i> instagram </a></li>
            <li class="menu__item"><a class="menu__link" href="#"> <i class="fab fa-youtube"></i> youtube </a></li>
            <li class="menu__item"><a class="menu__link" href="#"> <i class="fab fa-github"></i> github </a></li>
        </ul>
